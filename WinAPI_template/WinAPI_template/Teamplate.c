...
WNDCLASSEX WndClassEx =
{
	...
	(HICON)0, (HCURSOR)0, (HBRUSH)0, (TCHAR *)0, (TCHAR *)MAIN_CLASS_NAME, 0
};
...
INT WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpCmdLine, int nCmdShow)
{
	...
	CreateWindowEx(0, MAIN_CLASS_NAME, CAPTION, windowStyle, 0, 0, R.right, R.bottom, (HWND)0, (HMENU)0, hInstance, (LPVOID)0);
